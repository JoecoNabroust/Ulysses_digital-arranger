...
const Giscus = dynamic(() => import("@giscus/react"), {
  ...
  loading: () => (
    <div className="flex min-h-40 items-center justify-center rounded-xl border border-charcoal/10 bg-white">
      <div className="flex items-center gap-2 font-ui text-base text-charcoal/85">
...
export function FeedbackComments() {
  if (!repoId || !categoryId) {
    return (
      <div className="rounded-xl border border-charcoal/10 bg-white p-4 font-ui text-base text-charcoal/90">
    ...
    <section className="space-y-4">
      <div className="rounded-xl border border-charcoal/10 bg-white p-4">
        <div className="mb-2 flex items-center gap-2">
          ...
          <h2 className="font-ui text-sm font-semibold uppercase tracking-wide text-charcoal/85">Scholar&apos;s Note</h2>
        </div>
        <p className="font-ui text-base leading-relaxed text-charcoal/95">
