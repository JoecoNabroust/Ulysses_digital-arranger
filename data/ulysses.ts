...
export const characterProfiles: CharacterProfile[] = [
  {
    ...
    episodes: {
      ...
      7: { status: "Present", note: "Moves through the newsroom economy while placing ad business." },
      8: { status: "Present", note: "Wanders lunchtime cityscapes and reflects on appetite." },
      9: { status: "Present", note: "Briefly crosses Stephen's library debate orbit." },
      ...
      14: { status: "Present", note: "Hospital episode tracks his ethical and observational stance." },
